...
// function calls to be computed."
    ...
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x0a, "ASL", 1, 2, AddressingMode::NoneAddressing), // Accumulator addressing done implicitly
        ...
        OpCode::new(0x49, "EOR", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y),
